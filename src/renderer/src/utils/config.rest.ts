...
const config = {
  ...
  authBy: 'id',
  apiPrefix: `${APIV1}`,
  apiHeader: { Accept: 'application/json', 'Content-Type': 'application/json', Authorization: '' },
  rest: {
    apiUser: '/users/:id',
    apiUsers: '/users',
  ...
  api: {
    ...
    transTypeList:
      '/misc/code/TRANSTYPE?fields=miscName,miscDesc,miscVariable&as=code,type,variable',
